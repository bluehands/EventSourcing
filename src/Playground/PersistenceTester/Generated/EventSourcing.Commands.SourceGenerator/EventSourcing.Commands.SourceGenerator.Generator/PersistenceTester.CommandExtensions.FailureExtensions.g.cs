...
namespace PersistenceTester
{
    ...
    public static partial class ProcessingResult
    {
        ...
        public static global::EventSourcing.Commands.ProcessingResult<string> Failed(global::System.Collections.Generic.IReadOnlyCollection<global::EventSourcing.EventPayload> payloads, string error) => global::EventSourcing.Commands.ProcessingResult<string>.Failed(payloads, error);
        public static global::EventSourcing.Commands.ProcessingResult<string> Failed(string error) => Failed([], error);
    }
}