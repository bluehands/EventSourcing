...
//TError has to implement EventSourcing.Commands.IError. To use an external Result type, use the attribute with error type only, see Program.cs in PersistenceTester.
